                            ...
                            <div class="form-body">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text"  type="text" name="name" value="{{ old('name') }}" placeholder="اضافة وظيفة" class="form-control"> 
                                    </div>
                                </div>
                                            ...
                                            <td>
                                                <select name="permissions[]" class="form-control select2" multiple="">
                                                    @foreach($cruds as $permission_map)
                                                        <option value="{{$permission_map->en_name . '_' . $model->name}}">{{ $permission_map->ar_name}}</option>
                                                    @endforeach
                                                </select>
                                            </td>
                                        </tr>
